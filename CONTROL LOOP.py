...
from teseract import TemperatureReader
...
def main():
    ...
    #x,y,w,h=1842,142,55,32
    # por ejemplo ~15 Hz de OCR; ajusta period según necesites
    reader = TemperatureReader(x, y, w, h, period=0.03).start()
    ...
    textbox = TextBox(axbox, "Setpoint °C", initial=str(SETPOINT0))
